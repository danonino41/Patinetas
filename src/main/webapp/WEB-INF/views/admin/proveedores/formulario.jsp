            ...
            <div class="row">
                <main class="col-md-9 m-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h2>
                            <i class="bi bi-building-gear me-2"></i> ${empty proveedor.id ? 'Nuevo' : 'Editar'} Proveedor
                        </h2>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <a href="${pageContext.request.contextPath}/admin/proveedores" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/proveedores" method="post">
                                ...
                                <button type="submit" class="btn btn-primary">${empty proveedor.id ? 'Registrar' : 'Actualizar'}</button>
