...
<html>
        ...
        <style>
            .hero-section {
                background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),
                    url('https://c8.alamy.com/comp/2C21B6Y/skateboarding-vector-background-web-banner-poster-one-continuous-line-drawing-of-skater-with-lettering-skateboarding-2C21B6Y.jpg') no-repeat center center;
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <section class="hero-section text-center">
                <div class="container">
                    ...
                    <a href="${pageContext.request.contextPath}/productos" class="btn btn-danger btn-lg">Ver
                        Catálogo</a>
                </div>
            </section>
                        ...
                        <div class="col">
                            <div class="card h-100 shadow-sm rounded-3">
                                <img src="${producto.imagen}" class="card-img-top" alt="${producto.nombre}" 
                                     style="height: 200px; object-fit: cover; border-radius: 0.75rem 0.75rem 0 0;">
                                <div class="card-body d-flex flex-column">
                                    <h5 class="card-title mb-3">${producto.nombre}</h5>
                                    <p class="card-text text-truncate" style="font-size: 0.9rem; color: #666;">${producto.descripcion}</p>
                                    <h5 class="text-success font-weight-bold">S/${producto.precio}</h5>
                                </div>
                                <div class="card-footer bg-white border-0">
                                    <a href="${pageContext.request.contextPath}/productos?id=${producto.id}" class="btn btn-success w-100 rounded-pill shadow-sm">
                                        Ver Detalles
                                    </a>
                                </div>
                            </div>
        ...
        <div class="offcanvas offcanvas-end" style="background-color: white;
             color: black;" tabindex="-1" id="cartOffcanvas">
