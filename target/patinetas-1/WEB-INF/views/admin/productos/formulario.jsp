        ...
        <div class="row">
            <main class="col-md-9 m-auto col-lg-10 px-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/admin/productos" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="proveedorId" name="proveedorId" required>
                                        ...
                                        <c:forEach items="${proveedores}" var="proveedor">
                                            <option value="${proveedor.id}" ${producto.proveedorId == proveedor.id ? 'selected' : ''}>
                                                ${proveedor.nombre}
                                            </option>
                                        </c:forEach>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="imagen" name="imagen" ${empty producto.id ? 'required' : ''}>

                                <c:if test="${not empty producto.imagen}">
                                    <div class="mt-2">
                                        <img src="${pageContext.request.contextPath}/${producto.imagen}" alt="Imagen actual" style="max-height: 200px;">
