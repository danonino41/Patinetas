            ...
            <main class="col-md-9 m-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="${pageContext.request.contextPath}/admin/proveedores/nuevo" class="btn btn-sm btn-primary">
                            ...
                            <c:forEach items="${proveedores}" var="proveedor">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/proveedores/eliminar?id=${proveedor.id}" 
